<div class="w-full bg-slate-100 mt-10">
    <div class="w-4/6 mx-auto px-8 py-10">
        <h2 class="text-3xl font-semibold mb-3">Get in touch.</h2>
        <p class="mb-10 text-xl">For business inquire, please contact me below.</p>
        @if(session('send-message'))
        <x-message-notice type="message" :value="session('send-message')"></x-message-notice>
        @endif
        <div class="bg-white shadow-lg rounded-lg grid grid-cols-2">
            <div class="cols-1 h-full p-5">
                ...
                <form action="{{ route('send-message') }}" method="POST">
                    ...
                    <button type="submit" class="px-4 py-2 rounded bg-blue-500 hover:bg-blue-600 text-gray-100">Send Message</button>
                </form>
            </div>
            <div class="cols-1 h-full p-5 bg-[#183153] text-gray-100">
                <h3 class="text-2xl w-3/4 mx-auto font-semibold mb-5">Contact Information.</h3>
