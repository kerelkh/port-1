    ...
    <div class="p-2">
        ...
        <div class="mt-5">
            ...
            <form action="/setting/update/profile" method="POST" class="mt-2" id="form-update-profile">
                ...
                <div class="flex items-center">
                    ...
                    <div class="flex-1">
                        <button type="submit" class="mt-5 sm:mt-2 p-2 bg-blue-400 text-gray-50 rounded-xl hover:bg-blue-600">Update</button>
                    </div>
                </div>
            </div>
            </form>
        ...
        <div class="mt-5">
            ...
            <div class="my-5">
                ...
                @endif
                <form action="/setting/update/banner" method="POST" enctype="multipart/form-data" class="flex flex-col sm:flex-row gap-3">
                    @csrf
                    ...
                    @else
                    <img src="{{ asset('images/image-placeholder.png') }}" alt="Banner temporary" id="img-temp" class="w-full sm:w-1/2">
                    @endif
